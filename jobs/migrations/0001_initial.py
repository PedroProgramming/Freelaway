# Generated by Django 4.1.7 on 2023-03-30 23:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('C', 'Em criaçao'), ('AA', 'Arguardando aprovação'), ('F', 'Finalizado')], default='AA', max_length=2)),
